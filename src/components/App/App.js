...
import { Avatar, Box, ButtonBase, Container, Drawer, Grid, Stack, styled, Typography } from '@mui/material';
...
const App = () => {
  ...
  return (
    <Root sx={{ paddingRight: pin ? '400px' : 'unset', overflow: 'auto' }}>
      <Container maxWidth='md' sx={{ pb: 6}}>
        ...
        <Grid container spacing={.5}>
         ...
         <Grid item xs={4}>
           <ButtonBase sx={{ width: '100%', background: 'rgba(0,0,0,.1)', aspectRatio: '1/1', p: 3, '& svg': { stroke: 'rgba(0,0,0,.6)' } }}><AddIcon /></ButtonBase>
         </Grid>
